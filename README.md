...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/UI%20Style-Guangzhou%20Official%20Lezai%20v2.1.7-blue.svg" alt="Guangzhou Official Lezai v2.1.7">
  <img src="https://img.shields.io/badge/Security%20Audit-7%2F7%20Passed-brightgreen.svg" alt="Security Audit">
...
### 核心架构构想与官方原生“叻仔”政务问答体系 (v2.1.7 纯净自然稳定版)
系统对标**广州市人民政府门户网站（`www.gz.gov.cn`）**政策库、**广东政务服务网（`www.gdzwfw.gov.cn`）**及广州市政务官方 AI 助手**“叻仔”**，建立中型政务服务数据库，实现权威、智能且富有温度的政务服务体验：
1. **1:1 复刻广州政务官方“叻仔”视觉体系（彻底去除 AI 工具模板感）**：
   - **官方“叻仔”IP形象与空间**：顶部配置官方政务虚拟数字人“叻仔”专属标识、政务专员头衔与极简圆弧线框定位矢量图标（Teardrop Map Pin）；
   - **适老化无障碍国标字号切换**：顶部右侧集成官方标配“字号设置：大 | 中 | 小”，无级动态缩放全窗排版字号与行距，长辈老人一键放大轻松阅读；
   - **官方天蓝微光科技网格底纹**：以微浅天蓝渐变与数字网络点阵为底色，彻底褪除第三方套壳 AI 工具感；
   - **底部高频政务推荐轮播**：底部常驻“推荐主题：身份证 · 机动车驾驶证 · 社会保障卡 · 养老保险 · 医保登记 · 公积金贷款 · 公积金提取 · 居住证 · 卫生许可”，一键点击即问即答；
   - **极简胶囊输入与悬浮发射**：圆角胶囊输入框搭配经典蓝色纸飞机发送图标，点击快捷标签即刻清空输入框残留。
2. **人本温情民生关怀与政策精准联想（拒绝八股文与生硬说教）**：
   - 彻底打破“【快速答疑】”、“【办事要点】”等机械式 AI 模板色块堆砌；
   - **自然流畅齐头排版**：正文采用自然齐整的会话流，段落自适应换行，字距行距适度舒适；
   - **懂民生、有温度的情境化主动服务**：当市民提出生活化、祝寿类咨询（如*“我要办80大寿”*）时，助手首先奉上真诚暖心的寿辰祝愿，随后主动联想并提醒广州市户籍年满80周岁长寿保健金（200元/月）及年满65周岁老年人优待卡（免费乘车乘渡轮）等法定敬老惠民红利，并附广东政务服务网直达申办链接；
3. **权威双轨可溯源办事机制**：
   - **政策条文解读**：左下角以规整优雅的单行小字呈现官方发文字号依据（如《广州市住房公积金提取管理办法》`穗公积金规字〔2023〕1号`），点击即可平滑展开查验法定原文；
   - **办事向导结构化直达**：清晰整理准入条件、申报材料、承诺时限与办事流程，并提供**广东政务服务网具体服务页面的真实在线申报直达通道**；
4. **三重零 Emoji 纪律防御体系**：
   - 通过大模型 Prompt 公文纪律约束 + Java 后端 SSE 流式过滤器 + 前端 DOM 严格转义过滤，确保全流程**严格 0 Emoji**；
5. **官方首页限定挂载与全面覆盖**：
   - 油猴脚本精准覆盖广东政务服务网全新门户 `https://www.gdzwfw.gov.cn/portal/v3/index*`（广州专区 `region=440100`）及各级官网首页，智能过滤内嵌子页面，实现“无感伴随、不占空间、用完即走”。
...
| **前端交互规范** | 原生 JavaScript + Shadow DOM | 物理样式隔离，苹果级半透明毛玻璃美学（Glassmorphism），自然人本语言，极简降噪 |
