...
public class GovWorkOrderController {
    ...
    public Result<Map<String, Object>> aiTriage(@RequestBody Map<String, String> body) {
        ...
        String suggestedDept = "广州市政务服务和数据管理局";
